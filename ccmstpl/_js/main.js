...
window.setTimeout(function(){document.getElementById("loading_div").style.opacity="0";},100);
window.setTimeout(function(){document.getElementById("loading_div").style.display="none";},1000);
