...
window.setTimeout(function(){document.getElementById("wrapper").style.opacity="1";},250);
...
loadFirst("//cdn.jsdelivr.net/npm/jquery-validation@1.19.0/dist/jquery.validate.min.js",function(){ /* jquery.validate loaded */
	loadFirst("//cdn.jsdelivr.net/jquery.validation/1.16.0/additional-methods.min.js",function(){ /* validate additional-methods loaded */
		$.validator.addMethod(
			"badCharRegex",
