							...
							<form action="/{CCMS_LIB:_default.php;FUNC:ccms_lng}/user/" id="loginForm" method="post">
								...
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input class="form-control" id="loginEmail" name="loginEmail" placeholder="Email" type="email" autocomplete="on" readonly onfocus="this.removeAttribute('readonly');">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input class="form-control" id="loginPassword" name="loginPassword" placeholder="Password" type="password" autocomplete="on" readonly onfocus="this.removeAttribute('readonly');">
									</div>
								</div>
								<div class="form-group">
