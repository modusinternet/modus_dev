! function(e) {
   ...
   var S = function() {
         ...
         }, e.version = "8.4.6", e.options = i, e.configs = s, e.addons = {}, e.wrappers = {}, e.node = {}, e.vars = {}, e
      }(),
      M = {
         blockUI: !0,
         moveBackground: !0
   ...
   S.options.navbars = be, S.configs.navbars = ge, S.configs.classNames.navbars = {
      ...
      next: function(e) {
         ...
         e.append(a), this.bind("openPanel:start", (function(e) {
            t = e.querySelector("." + s.conf.classNames.navbars.panelNext), n = t ? t.getAttribute("href") : "", i = t ? t.innerHTML : "", n ? a.setAttribute("href", n) : a.removeAttribute("href"), a.classList[n || i ? "remove" : "add"]("mm-hidden"), a.innerHTML = i
      ...
      title: function(e) {
         ...
         o.append(r), e.append(o), this.bind("openPanel:start", (function(e) {
            e.parentElement.matches(".mm-listitem_vertical") || ((i = e.querySelector("." + a.conf.classNames.navbars.panelTitle)) || (i = e.querySelector(".mm-navbar__title span")), (t = i ? i.getAttribute("href") : "") ? o.setAttribute("href", t) : o.removeAttribute("href"), n = i ? i.innerHTML : "", r.innerHTML = n)
         })), this.bind("openPanel:start:sr-aria", (function(e) {
   ...
   var je;
   t.default = S;
   window.Mmenu = S, (je = window.jQuery || window.Zepto || null) && (je.fn.mmenu = function(e, t) {
      var n = je();
